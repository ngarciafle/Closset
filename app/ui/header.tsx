        ...
        <header className='bg-background-secondary grid grid-cols-4 pl-4 pr-4 pt-1 m-0 w-full h-12  shrink-0 z-20'>
            ...
            <Link href="/" className='group grid grid-cols-1 grid-rows-1'>
                <Image
                    ...
                    alt='App icon'
                />
                <p className='opacity-50 text-background col-start-1 row-start-1 z-20 group-hover:opacity-100 transition-opacity self-center justify-self-center'>closet</p>
            </Link>
...
>>>>>>> e9adbea5bd2df5b2d3e6cd10eab91836d09e8618
}